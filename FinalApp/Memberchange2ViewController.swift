//
//  Memberchange2ViewController.swift
//  FinalApp
//
...
import UIKit
import Firebase
class Memberchange2ViewController:UIViewController ,UITableViewDelegate, UITableViewDataSource{
                    ...
                    if let dic = snapshot.value as? [String: AnyObject]{
                        ...
                        self.ref.child("Members").child(uid!).observeSingleEvent(of: .value, with: {(snapshot) in
                            ...
                            if let dataDict2 = snapshot.value as? [String: AnyObject]{
                                ...
                                if(company == companyNum) && (changemember == name ) && (dayoffsy ==
    ...
    @IBAction func search(_ sender: Any) {
        ...
        let dest = Storyboard.instantiateViewController(withIdentifier: "Memberchange2ViewController") as!  Memberchange2ViewController
