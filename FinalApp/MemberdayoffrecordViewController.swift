//
//  MemberdayoffrecordViewController.swift
//  FinalApp
//
...
import UIKit
import Firebase
class MemberdayoffrecordViewController: UIViewController  ,UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate{
